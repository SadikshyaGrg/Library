...
<body>
    ...
    <button type="button" class="btn btn-light text-light btn-lg"><a  class="text-decoration-none"  href="add_book.php">Add Books</a></button>
    </br></br>
                                ...
                                $quantity=$row['quantity'];
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        href="update_book.php?cn=<?php echo $row['id']?>">Update</a></button>
                                        <button class="btn btn-outline-danger " name=""><a class="text-dark text-decoration-none"
                                         href="delete_book.php?cn=<?php echo $row['id']?>">Delete</a></button>
                                    </td>
                                 </tr>
                                 <?php
                               }
